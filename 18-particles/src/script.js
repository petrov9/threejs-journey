...
let particlesGeometry = new THREE.BufferGeometry(1, 32,32);
let count = 20000;
...
let pointsMaterial = new THREE.PointsMaterial({
    size: 0.1,
    sizeAttenuation: true, //if far from camera: small else big
    // color: "#ff88cc",
    transparent: true,
...
let particles = new THREE.Points(particlesGeometry, pointsMaterial);
scene.add(particles)
