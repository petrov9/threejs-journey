...
import shadowmap_pars_fragmentGlsl from "three/src/renderers/shaders/ShaderChunk/shadowmap_pars_fragment.glsl";

let textureLoader = new THREE.TextureLoader();
let bakedShadowTexture = textureLoader.load("/textures/bakedShadow.jpg");
let simpleShadowTexture = textureLoader.load("/textures/simpleShadow.jpg");
...
let directionLightCameraHelper = new THREE.CameraHelper(directionalLight.shadow.camera);
...
let spotLight = new THREE.SpotLight(0xffffff, 0.4, 10, Math.PI * 0.3);
...
let pointCameraHelper = new THREE.CameraHelper(pointLight.shadow.camera);
...
const tick = () =>
{
    ...
    sphereShadow.material.opacity = Math.abs(1 - sphere.position.y) * 0.3
