...
fontLoader.load(
    ...
    (font) => {
        let textGeometry = new TextGeometry("Anton Petrov", {
            font,
            size: 0.5,
            height: 0.2,
            curveSegments: 12,
        ...
        let torusGeometry = new THREE.TorusGeometry(0.3, 0.2, 20, 45);

        for (let i = 0; i <1000; i++) {
            let donat = new THREE.Mesh(
                torusGeometry,
                material
            );
            ...
            donat.scale.set(random, random, random)
